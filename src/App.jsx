...
// ═══ CARD POOL ═══════════════════════════════════════════════════════════════
const POOL = [
  { id: "wolf", name: "Stonefang Wolf", type: "creature", region: "Thornwood", rarity: "Common", cost: 2, atk: 3, hp: 2, keywords: ["Swift"], border: "#4a9020", seed: 7, bloodpact: false, imageUrl: "/alt-art/stonefang-anime-island.png", imageScale: 1.1, ability: "Swift. Can attack immediately.", flavor: "It hunts what you're holding.", effects: [], levelUp: [{ at: 2, bonus: { atk: 1, hp: 0 }, label: "Pack Leader" }, { at: 4, bonus: { atk: 1, hp: 1 }, label: "Alpha" }] },
  { id: "guard", name: "Thornwood Guard", type: "creature", region: "Thornwood", rarity: "Common", cost: 3, atk: 1, hp: 5, keywords: [], border: "#4a9020", seed: 15, bloodpact: false, imageUrl: "/alt-art/guard-anime-island.png", imageScale: 1.1, ability: "On Play: Give +1 HP to all allies.", flavor: "The trees remember.", effects: [{ trigger: "onPlay", effect: "buff_allies", atk: 0, hp: 1 }], levelUp: [{ at: 3, bonus: { atk: 0, hp: 2 }, label: "Ironbark" }, { at: 5, bonus: { atk: 1, hp: 2 }, label: "Ancient Oak" }] },
  { id: "druid", name: "Rootcaller Druid", type: "creature", region: "Thornwood", rarity: "Uncommon", cost: 3, atk: 2, hp: 3, keywords: [], border: "#4a9020", seed: 111, bloodpact: false, imageUrl: "/alt-art/druid-anime-island.png", imageScale: 1.1, ability: "On Play: Heal hero for 3.", flavor: "She asks the roots.", effects: [{ trigger: "onPlay", effect: "heal_hero", amount: 3 }], levelUp: [{ at: 2, bonus: { atk: 0, hp: 1 }, label: "Elder" }, { at: 4, bonus: { atk: 1, hp: 2 }, label: "Arch-Druid" }] },
  { id: "tangle", name: "Tanglewood Trap", type: "spell", region: "Thornwood", rarity: "Rare", cost: 2, atk: null, hp: null, keywords: [], border: "#4a9020", seed: 112, bloodpact: false, imageUrl: "/alt-art/tangle-anime-island.png", imageScale: 1.1, ability: "Deal 2 damage to all enemies.", flavor: "The forest does not warn.", effects: [{ trigger: "onPlay", effect: "damage_all_enemies", amount: 2 }] },
  { id: "env_grove", name: "Ancient Grove", type: "environment", region: "Thornwood", rarity: "Uncommon", cost: 2, atk: null, hp: null, keywords: [], border: "#4a9020", seed: 113, bloodpact: false, imageUrl: "/alt-art/env_grove-anime-island.png", imageScale: 1.1, ability: "ENV: Allies heal 1 HP each turn.", flavor: "Under the canopy, wounds close.", effects: [{ trigger: "onTurnStart", effect: "heal_all_allies", amount: 1 }] },
  { id: "wisp", name: "Echo Wisp", type: "creature", region: "Shattered Expanse", rarity: "Uncommon", cost: 2, atk: 2, hp: 2, keywords: ["Echo"], border: "#9050d8", seed: 42, bloodpact: false, imageUrl: "/alt-art/wisp-anime-island.png", imageScale: 1.1, ability: "Echo - 1/1 ghost replays next turn.", flavor: "The Rift repeats.", effects: [], levelUp: [{ at: 2, bonus: { atk: 0, hp: 1 }, label: "Resonant" }, { at: 4, bonus: { atk: 1, hp: 1 }, label: "Twin Soul" }] },
  { id: "shard", name: "Rift Shard", type: "creature", region: "Shattered Expanse", rarity: "Common", cost: 1, atk: 2, hp: 1, keywords: ["Swift"], border: "#9050d8", seed: 120, bloodpact: false, imageUrl: "/alt-art/shard-anime-island.jpg", imageScale: 1.1, ability: "Swift. On Death: Draw a card.", flavor: "It shatters. You learn.", effects: [{ trigger: "onDeath", effect: "draw", amount: 1 }], levelUp: [{ at: 2, bonus: { atk: 1, hp: 0 }, label: "Prism" }, { at: 4, bonus: { atk: 1, hp: 1 }, label: "Crystal Core" }] },
  { id: "weaver", name: "Timeline Weaver", type: "creature", region: "Shattered Expanse", rarity: "Rare", cost: 4, atk: 2, hp: 4, keywords: ["Fracture"], border: "#9050d8", seed: 121, bloodpact: false, imageUrl: "/alt-art/weaver-anime-island.png", imageScale: 1.1, ability: "Fracture. On Play: Allies get +1 ATK.", flavor: "She knits time into armor.", effects: [{ trigger: "onPlay", effect: "buff_allies", atk: 1, hp: 0 }], levelUp: [{ at: 2, bonus: { atk: 1, hp: 1 }, label: "Chrono Sage" }, { at: 4, bonus: { atk: 2, hp: 1 }, label: "Time Lord" }] },
  { id: "velrun", name: "Velrun", type: "champion", region: "Shattered Expanse", rarity: "Legendary", cost: 5, atk: 6, hp: 6, keywords: ["Fracture","Shield"], border: "#9050d8", seed: 99, bloodpact: false, imageUrl: "/alt-art/velrun-anime-island.jpg", imageScale: 1.1, ability: "Fracture. On Play: 2 damage to enemy hero.", flavor: "He ruled three timelines. Lost them all.", effects: [{ trigger: "onPlay", effect: "damage_enemy_hero", amount: 2 }], levelUp: [{ at: 3, bonus: { atk: 1, hp: 2 }, label: "Ascendant" }, { at: 5, bonus: { atk: 2, hp: 2 }, label: "Timeline King" }] },
  { id: "env_rift", name: "Fractured Rift", type: "environment", region: "Shattered Expanse", rarity: "Rare", cost: 3, atk: null, hp: null, keywords: [], border: "#9050d8", seed: 122, bloodpact: false, imageUrl: "/alt-art/env_rift-anime-island.png", imageScale: 1.1, ability: "ENV: All allies get +1 ATK.", flavor: "Reality bends.", effects: [{ trigger: "onTurnStart", effect: "buff_allies", atk: 1, hp: 0 }] },
  { id: "tide", name: "Tidecaller", type: "creature", region: "Azure Deep", rarity: "Rare", cost: 3, atk: 2, hp: 3, keywords: ["Resonate"], border: "#1880b8", seed: 13, bloodpact: false, imageUrl: "/alt-art/tide-anime-island.png", imageScale: 1.1, ability: "Resonate - +1 ATK per enemy card.", flavor: "The sea reads the shore.", effects: [], levelUp: [{ at: 2, bonus: { atk: 0, hp: 1 }, label: "Stormsurge" }, { at: 4, bonus: { atk: 1, hp: 1 }, label: "Tempest" }] },
  { id: "shellguard", name: "Shellguard", type: "creature", region: "Azure Deep", rarity: "Common", cost: 2, atk: 1, hp: 4, keywords: ["Shield"], border: "#1880b8", seed: 130, bloodpact: false, imageUrl: "/alt-art/shellguard-anime-island.jpg", imageScale: 1.1, ability: "Shield - blocks first hit.", flavor: "Patient as coral.", effects: [], levelUp: [{ at: 3, bonus: { atk: 0, hp: 2 }, label: "Reef Wall" }, { at: 5, bonus: { atk: 1, hp: 2 }, label: "Leviathan Shell" }] },
  { id: "current", name: "Riptide Current", type: "spell", region: "Azure Deep", rarity: "Common", cost: 1, atk: null, hp: null, keywords: [], border: "#1880b8", seed: 131, bloodpact: false, imageUrl: "/alt-art/current-anime-island.png", imageScale: 1.1, ability: "Draw 2 cards.", flavor: "The deep gives.", effects: [{ trigger: "onPlay", effect: "draw", amount: 2 }] },
  { id: "kraken", name: "Abyssal Kraken", type: "creature", region: "Azure Deep", rarity: "Epic", cost: 5, atk: 4, hp: 5, keywords: ["Anchor"], border: "#1880b8", seed: 132, bloodpact: false, imageUrl: "/alt-art/kraken-anime-island.png", imageScale: 1.1, ability: "Anchor. On Play: 3 damage to random enemy.", flavor: "It waited below. Always.", effects: [{ trigger: "onPlay", effect: "damage_random_enemy", amount: 3 }], levelUp: [{ at: 2, bonus: { atk: 1, hp: 1 }, label: "Deep Terror" }, { at: 4, bonus: { atk: 2, hp: 2 }, label: "Worldbreaker" }] },
  { id: "env_depths", name: "Sunken Depths", type: "environment", region: "Azure Deep", rarity: "Uncommon", cost: 2, atk: null, hp: null, keywords: [], border: "#1880b8", seed: 133, bloodpact: false, imageUrl: "/alt-art/env_depths-anime-island.png", imageScale: 1.1, ability: "ENV: Draw extra card each turn.", flavor: "The pressure reveals.", effects: [{ trigger: "onTurnStart", effect: "draw", amount: 1 }] },
  ...
  { id: "pyro", name: "Pyromancer", type: "creature", region: "Ashfen", rarity: "Uncommon", cost: 3, atk: 3, hp: 2, keywords: ["Bleed"], border: "#c04810", seed: 140, bloodpact: false, imageUrl: "/alt-art/pyro-anime-island.png", imageScale: 1.1, ability: "Bleed. On Play: 1 damage to ALL.", flavor: "Everything burns equally.", effects: [{ trigger: "onPlay", effect: "damage_all", amount: 1 }], levelUp: [{ at: 2, bonus: { atk: 1, hp: 1 }, label: "Firestarter" }, { at: 4, bonus: { atk: 2, hp: 1 }, label: "Inferno" }] },
  { id: "eruption", name: "Volcanic Eruption", type: "spell", region: "Ashfen", rarity: "Rare", cost: 4, atk: null, hp: null, keywords: [], border: "#c04810", seed: 141, bloodpact: false, imageUrl: "/alt-art/eruption-anime-island.png", imageScale: 1.1, ability: "4 to enemy hero. 1 to yours.", flavor: "The mountain remembers.", effects: [{ trigger: "onPlay", effect: "damage_enemy_hero", amount: 4 }, { trigger: "onPlay", effect: "damage_own_hero", amount: 1 }] },
  { id: "env_volcano", name: "Ashfen Caldera", type: "environment", region: "Ashfen", rarity: "Rare", cost: 3, atk: null, hp: null, keywords: [], border: "#c04810", seed: 142, bloodpact: false, imageUrl: "/alt-art/env_volcano-anime-island.png", imageScale: 1.1, ability: "ENV: +1 ATK to your creatures each turn.", flavor: "The heat forges warriors.", effects: [{ trigger: "onTurnStart", effect: "buff_allies", atk: 1, hp: 0 }] },
  { id: "sentinel", name: "Iron Sentinel", type: "creature", region: "Ironmarch", rarity: "Uncommon", cost: 3, atk: 2, hp: 4, keywords: ["Anchor"], border: "#6060a0", seed: 31, bloodpact: false, imageUrl: "/alt-art/sentinel-anime-island.jpg", imageScale: 1.1, ability: "Anchor - can't be removed.", flavor: "It never moved.", effects: [], levelUp: [{ at: 3, bonus: { atk: 1, hp: 1 }, label: "Immovable" }, { at: 5, bonus: { atk: 2, hp: 2 }, label: "Eternal Wall" }] },
  { id: "forgebot", name: "Forge Automaton", type: "creature", region: "Ironmarch", rarity: "Common", cost: 2, atk: 2, hp: 3, keywords: [], border: "#6060a0", seed: 150, bloodpact: false, imageUrl: "/alt-art/forgebot-anime-island.png", imageScale: 1.1, ability: "On Play: Random ally gets +1 ATK.", flavor: "Built to improve.", effects: [{ trigger: "onPlay", effect: "buff_random_ally", atk: 1, hp: 0 }], levelUp: [{ at: 2, bonus: { atk: 1, hp: 0 }, label: "Overclocked" }, { at: 4, bonus: { atk: 1, hp: 1 }, label: "War Engine" }] },
  { id: "shield_wall", name: "Iron Barricade", type: "spell", region: "Ironmarch", rarity: "Common", cost: 2, atk: null, hp: null, keywords: [], border: "#6060a0", seed: 151, bloodpact: false, imageUrl: "/alt-art/shield_wall-anime-island.png", imageScale: 1.1, ability: "All allies get +2 HP.", flavor: "The wall holds.", effects: [{ trigger: "onPlay", effect: "buff_allies", atk: 0, hp: 2 }] },
  { id: "colossus", name: "Ironmarch Colossus", type: "champion", region: "Ironmarch", rarity: "Legendary", cost: 6, atk: 5, hp: 8, keywords: ["Anchor", "Shield"], border: "#6060a0", seed: 152, bloodpact: false, imageUrl: "/alt-art/colossus-anime-island.png", imageScale: 1.1, ability: "Anchor + Shield. +1 ATK/turn.", flavor: "The empire fell. It did not.", effects: [{ trigger: "onTurnStart", effect: "self_buff", atk: 1, hp: 0 }], levelUp: [{ at: 3, bonus: { atk: 1, hp: 1 }, label: "Living Fortress" }, { at: 5, bonus: { atk: 2, hp: 2 }, label: "God-Machine" }] },
  { id: "falcon", name: "Sunveil Falcon", type: "creature", region: "Sunveil", rarity: "Common", cost: 2, atk: 3, hp: 1, keywords: ["Swift"], border: "#b89010", seed: 160, bloodpact: false, imageUrl: "/alt-art/falcon-anime-island.png", imageScale: 1.1, ability: "Swift.", flavor: "Sunlight made lethal.", effects: [], levelUp: [{ at: 2, bonus: { atk: 1, hp: 1 }, label: "Raptor" }, { at: 4, bonus: { atk: 1, hp: 1 }, label: "Sky Tyrant" }] },
  { id: "oracle", name: "Sand Oracle", type: "creature", region: "Sunveil", rarity: "Uncommon", cost: 3, atk: 2, hp: 3, keywords: [], border: "#b89010", seed: 161, bloodpact: false, imageUrl: "/alt-art/oracle-anime-island.jpg", imageScale: 1.1, ability: "On Play: Draw a card.", flavor: "The sands show what comes.", effects: [{ trigger: "onPlay", effect: "draw", amount: 1 }], levelUp: [{ at: 2, bonus: { atk: 0, hp: 1 }, label: "Seer" }, { at: 4, bonus: { atk: 1, hp: 2 }, label: "Prophet" }] },
  { id: "sun_strike", name: "Solar Flare", type: "spell", region: "Sunveil", rarity: "Rare", cost: 3, atk: null, hp: null, keywords: [], border: "#b89010", seed: 162, bloodpact: false, imageUrl: "/alt-art/sun_strike-anime-island.jpg", imageScale: 1.1, ability: "3 to random enemy, 1 to all.", flavor: "The sun does not forgive.", effects: [{ trigger: "onPlay", effect: "damage_random_enemy", amount: 3 }, { trigger: "onPlay", effect: "damage_all_enemies", amount: 1 }] },
  { id: "env_dunes", name: "Shifting Dunes", type: "environment", region: "Sunveil", rarity: "Uncommon", cost: 2, atk: null, hp: null, keywords: [], border: "#b89010", seed: 163, bloodpact: false, imageUrl: "/alt-art/env_dunes-anime-island.png", imageScale: 1.1, ability: "ENV: Creatures cost 1 less (min 1).", flavor: "The path shortens.", effects: [{ trigger: "passive", effect: "cost_reduction", amount: 1 }] },
  { id: "siphon", name: "Siphon Wraith", bleedAmount: 2, type: "creature", region: "Bloodpact", rarity: "Rare", cost: 3, atk: 5, hp: 3, keywords: ["Bleed"], border: "#a81830", seed: 77, bloodpact: true, imageUrl: "/alt-art/siphon-anime-island.jpg", imageScale: 1.1, ability: "BLOOD (3 HP). Double Bleed.", flavor: "It fed on the wound.", effects: [], levelUp: [{ at: 2, bonus: { atk: 1, hp: 1 }, label: "Hungering" }, { at: 4, bonus: { atk: 2, hp: 1 }, label: "Soul Drinker" }] },
  { id: "martyr", name: "Crimson Martyr", type: "creature", region: "Bloodpact", rarity: "Uncommon", cost: 2, atk: 3, hp: 4, keywords: [], border: "#a81830", seed: 88, bloodpact: true, imageUrl: "/alt-art/martyr-anime-island.png", imageScale: 1.1, ability: "BLOOD (2 HP). On Death: Heal 4.", flavor: "Sacrifice was its prayer.", effects: [{ trigger: "onDeath", effect: "heal_hero", amount: 4 }], levelUp: [{ at: 2, bonus: { atk: 0, hp: 2 }, label: "Devoted" }, { at: 4, bonus: { atk: 1, hp: 3 }, label: "Saint's Wrath" }] },
  { id: "bloodmage", name: "Hemomancer", type: "creature", region: "Bloodpact", rarity: "Epic", cost: 4, atk: 4, hp: 4, keywords: ["Bleed"], border: "#a81830", seed: 170, bloodpact: true, imageUrl: "/alt-art/bloodmage-anime-island.png", imageScale: 1.1, ability: "BLOOD (4 HP). Bleed. 2 Bleed to all.", flavor: "Blood is currency.", effects: [{ trigger: "onPlay", effect: "bleed_all_enemies", amount: 2 }], levelUp: [{ at: 2, bonus: { atk: 1, hp: 1 }, label: "Blood Lord" }, { at: 4, bonus: { atk: 2, hp: 2 }, label: "Sanguine King" }] },
  { id: "blood_pact", name: "Dark Bargain", type: "spell", region: "Bloodpact", rarity: "Uncommon", cost: 2, atk: null, hp: null, keywords: [], border: "#a81830", seed: 171, bloodpact: true, imageUrl: "/alt-art/blood_pact-anime-island.png", imageScale: 1.1, ability: "BLOOD (2 HP). Draw 3 cards.", flavor: "The cost is always you.", effects: [{ trigger: "onPlay", effect: "draw", amount: 3 }] },
